...
class InicioCineVentanas8 extends Thread{
	...
	public InicioCineVentanas8(ListasCine listas){
		this.listas = listas;
	...
	public void run() {
		try {
			InicioCineVentanas8 window = new InicioCineVentanas8();
			...
			RBoton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					case "16:00":
						...
						for (int j = 0; j < listas.listaReservas36.size(); j++) {
							boolean reser = listas.listaReservas36.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "16:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas36;
						pintarSala(listas.listaReservas36);
						
						break;

					case "18:00":
						
						for (int j = 0; j < listas.listaReservas37.size(); j++) {
							boolean reser = listas.listaReservas37.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "18:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas37;
						pintarSala(listas.listaReservas37);
						

						break;
					case "20:00":
						
						for (int j = 0; j < listas.listaReservas38.size(); j++) {
							boolean reser = listas.listaReservas38.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "20:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas38;
						pintarSala(listas.listaReservas38);
						

						break;
					case "22:00":
						
						for (int j = 0; j < listas.listaReservas39.size(); j++) {
							boolean reser = listas.listaReservas39.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "22:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas39;
						pintarSala(listas.listaReservas39);
						

						break;
					case "24:00":
						
						for (int j = 0; j < listas.listaReservas40.size(); j++) {
							boolean reser = listas.listaReservas40.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "24:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas40;
						pintarSala(listas.listaReservas40);
