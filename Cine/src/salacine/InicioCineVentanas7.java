...
class InicioCineVentanas7 extends Thread{
	...
	public InicioCineVentanas7(ListasCine listas){
		this.listas = listas;
	...
	public void run() {
		try {
			InicioCineVentanas7 window = new InicioCineVentanas7();
			...
			RBoton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					case "16:00":
						...
						for (int j = 0; j < listas.listaReservas31.size(); j++) {
							boolean reser = listas.listaReservas31.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "16:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas31;
						pintarSala(listas.listaReservas31);
						
						break;

					case "18:00":
						
						for (int j = 0; j < listas.listaReservas32.size(); j++) {
							boolean reser = listas.listaReservas32.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "18:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas32;
						pintarSala(listas.listaReservas32);
						

						break;
					case "20:00":
						
						for (int j = 0; j < listas.listaReservas33.size(); j++) {
							boolean reser = listas.listaReservas33.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "20:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas33;
						pintarSala(listas.listaReservas33);
						

						break;
					case "22:00":
						
						for (int j = 0; j < listas.listaReservas34.size(); j++) {
							boolean reser = listas.listaReservas34.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "22:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas34;
						pintarSala(listas.listaReservas34);
						

						break;
					case "24:00":
						
						for (int j = 0; j < listas.listaReservas35.size(); j++) {
							boolean reser = listas.listaReservas35.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "24:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas35;
						pintarSala(listas.listaReservas35);
