...
class InicioCineVentanas6 extends Thread{
	...
	public InicioCineVentanas6(ListasCine listas){
		this.listas = listas;
	...
	public void run() {
		try {
			InicioCineVentanas6 window = new InicioCineVentanas6();
			...
			RBoton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					case "16:00":
						...
						for (int j = 0; j < listas.listaReservas26.size(); j++) {
							boolean reser = listas.listaReservas26.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "16:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas26;
						pintarSala(listas.listaReservas26);
						
						break;

					case "18:00":
						
						for (int j = 0; j < listas.listaReservas27.size(); j++) {
							boolean reser = listas.listaReservas27.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "18:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas27;
						pintarSala(listas.listaReservas27);
						

						break;
					case "20:00":
						
						for (int j = 0; j < listas.listaReservas28.size(); j++) {
							boolean reser = listas.listaReservas28.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "20:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas28;
						pintarSala(listas.listaReservas28);
						

						break;
					case "22:00":
						
						for (int j = 0; j < listas.listaReservas29.size(); j++) {
							boolean reser = listas.listaReservas29.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "22:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas29;
						pintarSala(listas.listaReservas29);
						

						break;
					case "24:00":
						
						for (int j = 0; j < listas.listaReservas30.size(); j++) {
							boolean reser = listas.listaReservas30.get(j).isReserva();
							listas.listaReservasTemporal.get(j).setReserva(reser);
							sesion = "24:00";
						}
						
						listas.listaReservaFinal =listas.listaReservas30;
						pintarSala(listas.listaReservas30);
